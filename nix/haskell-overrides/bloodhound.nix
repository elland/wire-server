...
, deriving-aeson, errors, exceptions, fetchgit, hashable, hpack
, hspec, http-client, http-types, lib, microlens, microlens-aeson
, mtl, network-uri, pretty-simple, QuickCheck
