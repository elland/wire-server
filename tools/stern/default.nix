...
, http-types, imports, lens, lib, metrics-wai, mtl, split
, string-conversions, swagger, text, tinylog, transformers
, types-common, unliftio, unordered-containers, uuid, wai
, wai-extra, wai-predicates, wai-routing, wai-utilities, warp
, wire-api, yaml
}:
mkDerivation {
  pname = "stern";
  ...
  libraryHaskellDepends = [
    ...
    split string-conversions swagger text tinylog transformers
    types-common unliftio unordered-containers uuid wai wai-extra
