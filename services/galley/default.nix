...
, metrics-wai, mtl, optparse-applicative, pem, polysemy
, polysemy-wire-zoo, process, proto-lens, protobuf, QuickCheck
, quickcheck-instances, random, raw-strings-qq, resourcet, retry
, safe, safe-exceptions, saml2-web-sso, schema-profunctor
, semigroups, servant, servant-client, servant-client-core
, servant-server, servant-swagger, servant-swagger-ui, singletons
, sop-core, split, ssl-util, stm, string-conversions, swagger
, swagger2, tagged, tasty, tasty-cannon, tasty-hspec, tasty-hunit
, tasty-quickcheck, temporary, text, time, tinylog, tls
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    cryptonite currency-codes data-default either enclosed-exceptions
    errors exceptions extended extra galley-types gundeck-types
    HsOpenSSL HsOpenSSL-x509-system http-client http-client-openssl
    http-client-tls http-media http-types imports
    insert-ordered-containers lens memory metrics-wai mtl
    optparse-applicative pem polysemy polysemy-wire-zoo proto-lens
    protobuf QuickCheck random raw-strings-qq resourcet retry safe
    safe-exceptions saml2-web-sso semigroups servant servant-client
  ...
  executableHaskellDepends = [
    ...
    HsOpenSSL-x509-system hspec http-client http-client-openssl
    http-client-tls http-media http-types imports lens lens-aeson
    metrics-wai mtl optparse-applicative pem process proto-lens
    protobuf QuickCheck quickcheck-instances random raw-strings-qq
    retry safe saml2-web-sso schema-profunctor servant servant-client
    servant-client-core servant-server servant-swagger singletons
    sop-core ssl-util string-conversions tagged tasty tasty-cannon
    tasty-hunit temporary text time tinylog tls transformers
    ...
    warp-tls wire-api wire-api-federation wire-message-proto-lens yaml
  ];
  testHaskellDepends = [
