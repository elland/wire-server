...
, lens, lib, metrics-wai, mime, mmorph, mtl, optparse-applicative
, resourcet, retry, safe, servant, servant-client
, servant-client-core, servant-server, swagger, tagged, tasty
, tasty-hunit, text, time, tinylog, types-common
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    imports kan-extensions lens metrics-wai mime optparse-applicative
    resourcet retry safe servant servant-server swagger text time
    tinylog types-common unordered-containers uri-bytestring uuid wai
