...
, brig-types, bytestring, bytestring-conversion, Cabal
, cargohold-types, case-insensitive, cassandra-util, comonad
, conduit, containers, cookie, cryptobox-haskell, currency-codes
, data-default, data-timeout, directory, dns, dns-util, either
, email-validate, enclosed-exceptions, errors, exceptions, extended
, federator, filepath, fsnotify, galley-types, geoip2
, gundeck-types, hashable, HaskellNet, HaskellNet-SSL, hscim
, HsOpenSSL, HsOpenSSL-x509-system, html-entities, http-api-data
...
mkDerivation {
  ...
  isExecutable = true;
  setupHaskellDepends = [
    base Cabal containers directory filepath text
  ];
  libraryHaskellDepends = [
    ...
    imports insert-ordered-containers iproute iso639 lens lens-aeson
    metrics-core metrics-wai mime mime-mail mmorph MonadRandom mtl
    multihash mwc-random network network-conduit-tls
    optparse-applicative pem polysemy polysemy-wire-zoo proto-lens
    random-shuffle resource-pool resourcet retry ropes safe
    safe-exceptions saml2-web-sso schema-profunctor scientific scrypt
    servant servant-client servant-client-core servant-server
    servant-swagger servant-swagger-ui sodium-crypto-sign split
    ssl-util statistics stomp-queue string-conversions swagger swagger2
    tagged template text text-icu-translit time tinylog transformers
  ...
  testHaskellDepends = [
    aeson base binary bloodhound brig-types bytestring containers dns
    dns-util http-types imports lens polysemy polysemy-wire-zoo retry
