...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    imports insert-ordered-containers lens memory metrics-wai mtl
    network-uri optparse-applicative polysemy polysemy-check
    polysemy-plugin polysemy-wire-zoo QuickCheck raw-strings-qq retry
  ...
  executableHaskellDepends = [
    ...
    saml2-web-sso servant servant-multipart servant-server
    servant-swagger silently string-conversions swagger2 tasty-hunit
    text text-latin1 time tinylog transformers types-common
  ...
  testHaskellDepends = [
    ...
    polysemy-check polysemy-plugin polysemy-wire-zoo QuickCheck
    ...
    text-latin1 time tinylog transformers types-common
    unordered-containers uri-bytestring uuid wai wai-utilities warp
    wire-api x509 xml-conduit yaml
  ];
